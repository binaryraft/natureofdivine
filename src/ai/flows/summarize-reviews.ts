// SummarizeReviews flow
'use server';
/**
 * @fileOverview Summarizes online reviews for the book 'Nature of the Divine'.
 *
...
const SummarizeReviewsInputSchema = z.object({
  reviews: z
    .string()
    .describe('The online reviews for the book, separated by newlines.'),
});

export type SummarizeReviewsInput = z.infer<typeof SummarizeReviewsInputSchema>;

const SummarizeReviewsOutputSchema = z.object({
  summary: z.string().describe('A concise summary of the online reviews.'),
});
...
const summarizeReviewsPrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following online reviews for the book 'Nature of the Divine'.\n\nReviews:\n{{{reviews}}}`,
});
