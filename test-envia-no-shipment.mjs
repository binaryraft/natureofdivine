...
// Test WITHOUT shipment property
const testPayload = {
    origin: {
        name: "Alfas B",
...
let output = '=== ENVIA API TEST (No Shipment Property) ===\n\n';
...
fs.writeFileSync('envia-test-result.txt', output);
console.log('Results written to: envia-test-result.txt');
